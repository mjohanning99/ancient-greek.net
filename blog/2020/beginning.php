...
<body>
  <div class="article">
      ...
      <p>Firstly, it was paramount, obviously, to find a decent textbook which was suitable for an autodidact study of the language; something much easier said than done. After a lot of searching around and gathering advice, I finally settled on Hansen and Quinn&#39;s “Intensive Greek” — and was promptly staggered when it had arrived at my doorstep; for indeed, I had imagined it being intensive — it is, after all, in its title — but I did <em>not</em> expect to receive a book that weighed 3 pounds. I decided to simply go along with it and began studying the language using this book.<br></p>
      ...
      <p>I found this to be a really good way of studying a language, especially with an accompanying book discussing the language&#39;s grammar more in-depth, and was delighted to find out that there exists a version of this book for Ancient Greek as well, albeit made by a student in their free-time. This book — also known as <em>Ἡ Ἑλληνικὴ γλῶσσα καθ᾿ αὑτὴν φωτιζομένη</em> — is currently being written by Seumas Macdonald and is open-source! It is by no means as extensive as the book it tries to imitate, but I believe it to be an invaluable resource. There are still a few mistakes — such as <em>“τὸ Α καὶ τὸ Β γράμματά ἐστιν.”</em> where the word <em>γράμματά</em> has two accents instead of one (γράμματα). I am still not entirely sure whether that is perhaps an accentuation quirk, but I shall be sending him an email regarding this soon, so as to clear this matter up — and it has neither margin-notes nor any exercises or explanations, but I still believe it is a great companion to my <em>Intensive Greek</em> book. <br></p>

      <p>The latter problems are somewhat mitigated by two spin-off projects, namely <em>ὁ ἑταῖρος</em> (lit. <em>the companion</em>) which strives to provide some “extra practice and reinforcement”. Another is <em>Γραμματική καὶ μελετήματα εἰς Ἡ Ἑλληνικἠ γλῶσσα καθ᾿ αὑτὴν φωτιζόμενη</em> (Grammar and exercises for Lingua Graeca Per Se Illustrata) which provides just what the title promises — grammar and exercises. Unfortunately, however, both of these projects do not appear to have seen any update for nearly a year, so they only have very limited use as companions to the original text. <br></p>
