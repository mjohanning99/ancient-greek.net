...
<h2>Articles</h2>
  <div class="row">
    <div class="column">
      <h3><a href="greek.php" class="menu">Why study Ancient Greek?</a></h3>
      <p>Some details regarding what the reasons for my learning Ancient Greek — and ancient languages in general — are.</p>
    </div>
    <div class="column">
      <h3><a href="greekhow.php" class="menu">How to study Ancient Greek?</a></h3>
      <p>Some information about my method of learning the language.</p>
    </div>
    <div class="column">
      <h3><a href="#" class="denied">The pronunciation of Ancient Greek</a> (WIP)</h3>
      <p>Thoughts about the main methods of pronouncing Ancient Greek and how I, personally, do it.</p>
    </div>
  </div>
</div>
</body>
