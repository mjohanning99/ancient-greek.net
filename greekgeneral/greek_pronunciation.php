...
<body>
  ...
  <div class="article">
    ...
    <p>First, it is important to realise that language has gained a written form only comparatively recently. The first forms of actual writing that we know of date to around 5000 years in the past, namely either Ancient Egyptian or Sumerian<a class="footnote" href="#footnote_1" id="footnote_1_ref">Note [1]</a> — depending on whom you ask. It is simply naïve to believe that language did not exist before that time and that both written <i>and</i> spoken language simply appeared out of nowhere on the exact same date.</p>
    
    <p>Instead, human language is, in its essence, a verbal form of communication. Only recently have we begun to associate the <i>knowing</i> of a language with being able to write and read in it. This associating of writing with actual language has now, apparently, gone so far as to make people believe writing and language have coexisted forever; for I have, indeed, met two people who have expressed the opinion that they did, in fact, always exist simultaneously. It was entirely incomprehensible to them how the concept of <q>language</q> could exist without writing.<a class="footnote" href="#footnote_2" id="footnote_2_ref">Note [2]</a></p>
    
    <p>Back in the days of the Ancient Greeks (or the people who lived at the time of the New Testament) — which is, of course, what this site concerns itself with —, it was, however, most uncommon to find someone who was actually literate, especially if they were not from a large city such as Athens and of a high social status. There was simply no need for the majority of the populace to have the ability to read; people shared their knowledge and wisdom by word of mouth only for a large amount of time; indeed, even Homer’s poetic epics are largely told and retold orally before finally being written down.</p>

    <p>This oral recitation of literature also reveals why rhymes (or other methods, such as the metre found in Homeric poems) are such a common trait amongst very old pieces of literature — things that rhyme are, simply, easier to remember. It is, therefore, of the utmost importance to be able to properly pronounce words if things such as poems are to be recited properly.</p>

    <p>In addition to the above-mentioned reasons, Ancient Greek is still being spoken — albeit in a changed form called Modern Greek, or simply Greek. If one is to learn a languge whose descendant is still alive and well, should one not make an effort to properly reconstruct its sound and pronounce it the way it was pronounced 2,000 years ago? Or one might simply superimpose the pronunciation of the modern variety on to the ancient one, as many people in Greece themselves — when they have to learn Ancient Greek at school — do.</p>
  ...
  <div class="footnote">
    ...
    <p id="footnote_2">[2] This reminds me of a somewhat amusing anecdote I thought fitting to share here. A while ago, whilst talking to one of my colleagues at work, the topic of beer was brought up in our conversation. What exactly prompted this I do not remember, but I distinctly remember his saying that Germans had invented beer. I remarked, thereupon, that even the Ancient Egyptians enjoyed their own version of a pint, he was struck with disbelief and proclaimed that surely their <q>beer</q> cannot have been real beer at all — for it was us, the Germans, who have invented it! This was followed by my slowly nodding in fake agreement to move the conversation further. <a href="#footnote_2_ref">Back to text</a></p>
  </div>
</body>
