...
<div class="column-center">
  <div class="article">
    <h2>Update Archive — 2021</h2>
    <p>This archive contains all the updates from 2021 if you wish to see them once more. I have not changed anything on this page and the updates will remain the same. </p>
  </div>
</div>
...
<div class="article">
  <h2>December 8, 2021 — Design changes</h2>
  <p>As you may have already noticed, I have decided to change the design of the website slightly to make it look a bit more interesting. The changes include the following points:</p>
  <p><b>New and more icons</b>: I have replaced the icons I had been using for the menu portion at the very top of this page with new ones which look a bit more modern and which have a higher resolution. This, I hope, ensures that they are displayed clearly and sharply on most screens; the ones I used before were much too small and barely discernible.</p>
  <p><b>Encased main portion</b>: This may sound somewhat odd, but I am not sure how else to describe this change; the &lt;hr&gt; tag at the very top of the page, which separated the menu portion from the content of the website, has been replaced by by something new, namely a slighly curved border. The same border — but reversed — can now be found just above each page’s footer; this basically <q>encases</q> the main content of the website. These border may also contain some Ancient Greek text with some icons on either side — you sill find an example of this at the top of this page as well.</p>
  <p><b>Revamped footer</b>: The website’s footer has been a thorn in my side for a while now, as it has not been updated in over two years; indeed, if you look at the earliest snapshot of my first website (<a href="https://marvinjohanning.de">marvinjohanning.de</a>), you will find that the footer looks exactly the same as it did on this site until yesterday. Therefore, I was very happy to see my boyfriend’s mentioning that he wants to do something about my website’s footer — which he promptly did. I used his suggestion — even though I did not do it using a flexbox as he had suggested — and have replaced the old footer with this updated one.</p>
  <p>Additionally, I have finally stopped maintaining my former website marvinjohanning.de — I will keep the domain for obvious reasons, but if you attempt to access it, you will be redirected to ancient-greek.net, instead. The information you could find on there was outdated and my focus has shifted towards maintaining this website, instead.</p>
