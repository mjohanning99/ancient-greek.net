...
<div class="row">
  <div class="column-2">
    <h2>Fictional</h2>
    <h3><a href="letters/copper.php" class="menu">Ἐπιστολὴ αʹ — Περὶ τοῦ χαλκοῦ</h3></a>
  </div>

  <div class="column-2">
    <h2>Others</h2>
    <h3><a href="letters/language.php" class="menu">Ἐπιστολὴ βʹ — Περὶ τῶν γλωττῶν αʹ</h3></a>
    <h3><a href="letters/language2.php" class="menu">Ἐπιστολὴ γʹ — Περὶ τῶν γλωττῶν βʹ</h3></a>
    <h3><a href="letters/oldwords.php" class="menu">Ἐπιστολὴ εʹ — Περὶ τοῦ ἀκοῦσαι τοὺς λόγους τῶν παλαιῶν</h3></a>
  </div>
</div>
