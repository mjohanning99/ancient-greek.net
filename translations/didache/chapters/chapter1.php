...
<div align="center">
  <h1>Ἡ διδαχή — α’</h1>
  <h3 style="margin-bottom: 0px;">The Didache — #1</h3>
  <i>April-May 2021</i>
</div>
...
<div class="row">
  <div>
    ...
    <p class="blocktext">The first part of the Didache explaining the two paths in life. Please note that the Ancient Greek pronoun <i>ὑμεῖς</i> has been translated as <q>you</q> below, even though it is used to refer to the second personal plural (an English equivalent would, perhaps, be <i>y'all</i> or <i>you guys</i>). </p>
  </div>
</div>
