...
<body>
  ...
  <div class="article">
    <h2>The Importance of a Good Text Book</h2>
    ...
    <p>These latter resources greatly decrease the problem for autodidactic learners and make the text book <i>much</i> more accessible outside a classroom setting; indeed, I would go as far as saying that, having these answer keys, this is a really good book for those who which to teach themselves the language without the aid of a teacher. Truly, <i>βιβλίον ἀναγιγνώσκειν ἄξιον ἐστιν</i>.</p>
    <p>
  </div>
</body>
