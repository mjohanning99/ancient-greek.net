...
<body>
  ...
  <div class="article">
    <h2>How not to structure a textbook</h2>
      ...
      <p>Not unsurprisingly, I would say, I was rather stumped and learnt very little. There were no real exercises and very little reinforcement of the grammar that was learnt or, perhaps more accurately, the grammar thrown at the learner. One is given grammatical tables to memorise (such as the declination of nouns) and immediately gets greeted by a poem that is beyond my capabilities even now; surprisingly enough, I actually made a copy of it and it goes as follows: —</p>
      <blockquote>
      ...
      <p>This poem, written by the poet <i>Αλκμάν</i> (Alcman) is clearly rather complex and 99% of the words in this I have never heard of nor seen and it is thus beyond my understanding why such a text should be chosen and be presented to the learner at the end of the first chapter. Indeed, past me could not have put it more adequately: —</p>
      <blockquote>
        <i>In diesem Gedicht befindet sich eine sehr große Anzahl an neuen Vokabeln und grammatikalischen Konzepten.</i>
        <br><br>
        <q>This poem contains a great number of new vocabulary and grammatical concepts.</q>
      </blockquote>
      <p>Undoubtedly, a quote of Socrates comes to mind which, although used in a different context, fits rather adequately here as well, <q><i>ἓν οἶδα ὅτι οὐδὲν οἶδα</i></q> (One thing I know, namely that I know nothing) — though whether he actually said this is debatable.</p>
      <p>This latter quote of mine was actually one of the last things I wrote down as part of my study of this book as I quickly realised that this was not going to be a very productive affair. I am as of yet entirely perplexed in regards to who this book’s target audience was supposed to be. It does contain a rather large amount of cultural commentary and thus helps you understand the culture of this ancient civilisation better; but it was meant to be a book on learning the Ancient Greek language. Why in God’s name words such as <i>ἡ μέλισσα</i> (the bee) are introduced in the first chapter is beyond me — and I am in no way trying to downplay the importance of bees here, but rather trying to grasp why words that the average beginner of this language would not come across are being used this early on.</p>
      <p>Having written my own book teaching beginners to read Ancient Egyptian I have gathered some experience in this field; not much, admittedly, but enough to understand how <i>I personally think</i> a language should be introduced to the amateur and I am quite sure that the approach used in this particular book does not follow the approach that I would have taken at all. Perhaps it is aimed at those who have previously studied the language — which would then explain the rather sudden entrance into very advanced territory — but as I remember, it made itself out to be a book for complete beginners. Explaining the grammatical concepts more thoroughly and presenting the student with a larger amount of <i>simpler</i> texts to read would, in my opinion at least, improve this book greatly. Additionally, holding back the somewhat advanced grammatical concepts would also have the benefit of people not giving up after just the first chapter.</p>
  </div>
</body>
